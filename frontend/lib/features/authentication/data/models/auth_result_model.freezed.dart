...
/// @nodoc
@JsonSerializable()
class _$AuthResultModelImpl extends _AuthResultModel {
  ...
  @override
  String toString() {
    return 'AuthResultModel(user: $user, accessToken: $accessToken, refreshToken: $refreshToken, expiresAt: $expiresAt)';
  }
...
abstract class _AuthResultModel extends AuthResultModel {
  ...
  const _AuthResultModel._() : super._();
